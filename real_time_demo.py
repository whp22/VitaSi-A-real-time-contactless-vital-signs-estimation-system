...
def demo():
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, "tmp/training/with_relu/HB/HR_BR/model.ckpt")


        #cap = cv2.VideoCapture('/home/hwang266/Desktop/Wang/COHFACE-HR/38/1/data.avi')
